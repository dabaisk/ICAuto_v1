...
/**
 * @author Wiker Yong
 *         Email:<a href="mailto:wikeryong@gmail.com">wikeryong@gmail.com</a>
...
public class HttpUtils {
	 ...
	 * @throws Exception
	 */
	public static HttpRespons sendPostRes(String url, Map<String, String> params, Map<String, String> headers) {
		try {
			return new HttpUtils().makeContent(url, sendPostRequest(url, params, headers));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public static HttpURLConnection sendPostRequest(String url, Map<String, String> params, Map<String, String> headers)
			throws Exception {
